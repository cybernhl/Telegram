                ...
                if (count > 0) {
                    ...
                    while (pCur.moveToNext()) {
                        ...
                        if (type == ContactsContract.CommonDataKinds.Phone.TYPE_CUSTOM) {
                            ...
                            contact.phoneTypes.add(custom != null ? custom : LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PHONEMOBILE, R.string.PhoneMobile));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_HOME) {
                            contact.phoneTypes.add(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PHONEHOME, R.string.PhoneHome));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE) {
                            contact.phoneTypes.add(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PHONEMOBILE, R.string.PhoneMobile));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_WORK) {
                            contact.phoneTypes.add(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PHONEWORK, R.string.PhoneWork));
                        } else if (type == ContactsContract.CommonDataKinds.Phone.TYPE_MAIN) {
                            contact.phoneTypes.add(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PHONEMAIN, R.string.PhoneMain));
                        } else {
                            contact.phoneTypes.add(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PHONEOTHER, R.string.PhoneOther));
                        }
