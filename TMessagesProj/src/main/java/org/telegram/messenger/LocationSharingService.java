...
public class LocationSharingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateNotification(boolean post) {
        ...
        String text = String.format(str, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHLIVELOCATION, R.string.AttachLiveLocation), param);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            if (builder == null) {
                ...
                builder.addAction(0, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STOPLIVELOCATION, R.string.StopLiveLocation), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 2, stopIntent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_UPDATE_CURRENT));
            }
