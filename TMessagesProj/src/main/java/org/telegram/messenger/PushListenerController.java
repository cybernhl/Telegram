                        ...
                        if ("READ_HISTORY".equals(loc_key)) {
                            ...
                            if (processNotification) {
                                ...
                                if (loc_key.startsWith("REACT_") || loc_key.startsWith("CHAT_REACT_")) {
                                    ...
                                    switch (loc_key) {
                                        case "STORY_NOTEXT": {
                                            messageText = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORYNOTIFICATIONSINGLE);
                                            message1 = null;
                                            msg_id = story_id;
                                            break;
                                        }
                                        ...
                                        case "MESSAGE_SAME_WALLPAPER": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_WALLPAPERSAMENOTIFICATION, R.string.WallpaperSameNotification);
                                            break;
                                        }
                                        case "MESSAGE_WALLPAPER": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_WALLPAPERNOTIFICATION, R.string.WallpaperNotification);
                                            break;
                                        }
                                        case "MESSAGE_RECURRING_PAY": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PAYMENTINVOICE, R.string.PaymentInvoice);
                                            break;
                                        }
                                        case "MESSAGE_TEXT":
                                        ...
                                        case "MESSAGE_NOTEXT": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MESSAGE, R.string.Message);
                                            break;
                                        }
                                        case "MESSAGE_STORY": {
                                            messageText = LocaleController.formatString("NotificationStory", R.string.NotificationStory, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORY, R.string.Story);
                                            break;
                                        }
                                        case "MESSAGE_STORY_MENTION": {
                                            messageText = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORYNOTIFICATIONMENTION, R.string.StoryNotificationMention);
                                            message1 = null;
                                            break;
                                        }
                                        case "MESSAGE_PHOTO": {
                                            messageText = LocaleController.formatString("NotificationMessagePhoto", R.string.NotificationMessagePhoto, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHPHOTO, R.string.AttachPhoto);
                                            break;
                                        }
                                        case "MESSAGE_PHOTO_SECRET": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHDESTRUCTINGPHOTO, R.string.AttachDestructingPhoto);
                                            break;
                                        }
                                        case "MESSAGE_VIDEO": {
                                            messageText = LocaleController.formatString("NotificationMessageVideo", R.string.NotificationMessageVideo, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHVIDEO, R.string.AttachVideo);
                                            break;
                                        }
                                        case "MESSAGE_VIDEO_SECRET": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHDESTRUCTINGVIDEO, R.string.AttachDestructingVideo);
                                            break;
                                        }
                                        case "MESSAGE_SCREENSHOT": {
                                            messageText = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACTIONTAKESCREENSHOOT, R.string.ActionTakeScreenshoot).replace("un1", args[0]);
                                            break;
                                        }
                                        case "MESSAGE_ROUND": {
                                            messageText = LocaleController.formatString("NotificationMessageRound", R.string.NotificationMessageRound, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHROUND, R.string.AttachRound);
                                            break;
                                        }
                                        case "MESSAGE_DOC": {
                                            messageText = LocaleController.formatString("NotificationMessageDocument", R.string.NotificationMessageDocument, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHDOCUMENT, R.string.AttachDocument);
                                            break;
                                        }
                                        case "MESSAGE_STICKER": {
                                            if (args.length > 1 && !TextUtils.isEmpty(args[1])) {
                                                ...
                                                message1 = args[1] + " " + LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHSTICKER, R.string.AttachSticker);
                                            } else {
                                                messageText = LocaleController.formatString("NotificationMessageSticker", R.string.NotificationMessageSticker, args[0]);
                                                message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHSTICKER, R.string.AttachSticker);
                                            }
                                            break;
                                        }
                                        case "MESSAGE_AUDIO": {
                                            messageText = LocaleController.formatString("NotificationMessageAudio", R.string.NotificationMessageAudio, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHAUDIO, R.string.AttachAudio);
                                            break;
                                        }
                                        case "MESSAGE_CONTACT": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHCONTACT, R.string.AttachContact);
                                            break;
                                        }
                                        case "MESSAGE_QUIZ": {
                                            messageText = LocaleController.formatString("NotificationMessageQuiz2", R.string.NotificationMessageQuiz2, args[0], args[1]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_QUIZPOLL, R.string.QuizPoll);
                                            break;
                                        }
                                        case "MESSAGE_POLL": {
                                            messageText = LocaleController.formatString("NotificationMessagePoll2", R.string.NotificationMessagePoll2, args[0], args[1]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_POLL, R.string.Poll);
                                            break;
                                        }
                                        case "MESSAGE_GEO": {
                                            messageText = LocaleController.formatString("NotificationMessageMap", R.string.NotificationMessageMap, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHLOCATION, R.string.AttachLocation);
                                            break;
                                        }
                                        case "MESSAGE_GEOLIVE": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHLIVELOCATION, R.string.AttachLiveLocation);
                                            break;
                                        }
                                        case "MESSAGE_GIF": {
                                            messageText = LocaleController.formatString("NotificationMessageGif", R.string.NotificationMessageGif, args[0]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHGIF, R.string.AttachGif);
                                            break;
                                        }
                                        case "MESSAGE_GAME": {
                                            messageText = LocaleController.formatString("NotificationMessageGame", R.string.NotificationMessageGame, args[0], args[1]);
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHGAME, R.string.AttachGame);
                                            break;
                                        }
                                        ...
                                        case "CHANNEL_MESSAGE_GIVEAWAY": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BOOSTINGGIVEAWAY, R.string.BoostingGiveaway);
                                            break;
                                        }
                                        ...
                                        case "CHAT_MESSAGE_STICKER": {
                                            if (args.length > 2 && !TextUtils.isEmpty(args[2])) {
                                                ...
                                                message1 = args[2] + " " + LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHSTICKER, R.string.AttachSticker);
                                            } else {
                                        ...
                                        case "CHAT_MESSAGE_QUIZ": {
                                            ...
                                            message1 = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_POLLQUIZ, R.string.PollQuiz);
                                            break;
                                        }
                                        ...
                                        case "ENCRYPTED_MESSAGE": {
                                            messageText = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_YOUHAVENEWMESSAGE, R.string.YouHaveNewMessage);
