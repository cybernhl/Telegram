        ...
        ConnectionsManager.getInstance(currentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
            ...
            if (error != null) {
                ...
                if (error != null && error.text != null && error.text.contains("FLOOD_WAIT")) {
                    ...
                    if (fragment != null) {
                        BulletinFactory.of(fragment).createErrorBulletin(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FLOODWAIT, R.string.FloodWait)).show();
                    }
                }
                return;
            }
