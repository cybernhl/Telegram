...
class ChatsRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        if (deleted) {
            ...
            rv.setTextViewText(R.id.widget_edititem_text, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TAPTOEDITWIDGET, R.string.TapToEditWidget));
