    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (builder == null) {
            ...
            if (hasImportingHistory()) {
                builder.setTicker(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORIMPORTINGSERVICE, R.string.ImporImportingService));
                builder.setContentText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORIMPORTINGSERVICE, R.string.ImporImportingService));
            } else {
                builder.setTicker(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORIMPORTINGSTICKERSSERVICE, R.string.ImporImportingStickersService));
                builder.setContentText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORIMPORTINGSTICKERSSERVICE, R.string.ImporImportingStickersService));
            }
        }
