...
public class QuickRepliesSettingsActivity extends BaseFragment {
	...
	public View createView(Context context) {
		...
		actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPQUICKREPLIES, R.string.VoipQuickReplies));
		...
		public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
			switch (holder.getItemViewType()) {
				case 0: {
					...
					cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPQUICKREPLIESEXPLAIN, R.string.VoipQuickRepliesExplain));
					break;
				}
				case 1: {
				...
				case 12: {
					...
					if (position == reply1Row) {
						...
						defValue = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_QUICKREPLYDEFAULT1, R.string.QuickReplyDefault1);
					} else if (position == reply2Row) {
						settingsKey = "quick_reply_msg2";
						defValue = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_QUICKREPLYDEFAULT2, R.string.QuickReplyDefault2);
					} else if (position == reply3Row) {
						settingsKey = "quick_reply_msg3";
						defValue = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_QUICKREPLYDEFAULT3, R.string.QuickReplyDefault3);
					} else if (position == reply4Row) {
						settingsKey = "quick_reply_msg4";
						defValue = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_QUICKREPLYDEFAULT4, R.string.QuickReplyDefault4);
					}
				...
				case 4: {
					...
					cell.setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ALLOWCUSTOMQUICKREPLY, R.string.AllowCustomQuickReply), getParentActivity().getSharedPreferences("mainconfig", Context.MODE_PRIVATE).getBoolean("quick_reply_allow_custom", true), false);
				}
			}
		}
