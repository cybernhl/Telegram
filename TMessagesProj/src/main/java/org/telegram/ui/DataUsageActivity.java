...
public class DataUsageActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGE, R.string.NetworkUsage));
        ...
        for (int a = 0; a < viewPages.length; a++) {
            ...
            viewPages[a].listView.setOnItemClickListener((view, position) -> {
                ...
                if (position == adapter.resetRow) {
                    ...
                    builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETSTATISTICSALERTTITLE, R.string.ResetStatisticsAlertTitle));
                    builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETSTATISTICSALERT, R.string.ResetStatisticsAlert));
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGEMOBILETAB, R.string.NetworkUsageMobileTab));
        scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGEWIFITAB, R.string.NetworkUsageWiFiTab));
        scrollSlidingTextTabStrip.addTextTab(2, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGEROAMINGTAB, R.string.NetworkUsageRoamingTab));
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    if (position == resetRow) {
                        ...
                        textCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETSTATISTICS, R.string.ResetStatistics), false);
                        ...
                        if (position == callsSentRow) {
                            textCell.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_OUTGOINGCALLS, R.string.OutgoingCalls), String.format("%d", StatsController.getInstance(currentAccount).getSentItemsCount(currentType, type)), true);
                        } else if (position == callsReceivedRow) {
                            textCell.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_INCOMINGCALLS, R.string.IncomingCalls), String.format("%d", StatsController.getInstance(currentAccount).getRecivedItemsCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CALLSTOTALTIME, R.string.CallsTotalTime), time, false);
                            ...
                            textCell.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_COUNTSENT, R.string.CountSent), String.format("%d", StatsController.getInstance(currentAccount).getSentItemsCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_COUNTRECEIVED, R.string.CountReceived), String.format("%d", StatsController.getInstance(currentAccount).getRecivedItemsCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BYTESSENT, R.string.BytesSent), AndroidUtilities.formatFileSize(StatsController.getInstance(currentAccount).getSentBytesCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BYTESRECEIVED, R.string.BytesReceived), AndroidUtilities.formatFileSize(StatsController.getInstance(currentAccount).getReceivedBytesCount(currentType, type)), position == callsBytesReceivedRow);
                        }
                    }
                    break;
                }
                case 2: {
                    ...
                    if (position == totalSectionRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TOTALDATAUSAGE, R.string.TotalDataUsage));
                    } else if (position == callsSectionRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CALLSDATAUSAGE, R.string.CallsDataUsage));
                    } else if (position == filesSectionRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILESDATAUSAGE, R.string.FilesDataUsage));
                    } else if (position == audiosSectionRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALAUDIOCACHE, R.string.LocalAudioCache));
                    } else if (position == videosSectionRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALVIDEOCACHE, R.string.LocalVideoCache));
                    } else if (position == photosSectionRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALPHOTOCACHE, R.string.LocalPhotoCache));
                    } else if (position == messagesSectionRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MESSAGESDATAUSAGE, R.string.MessagesDataUsage));
                    }
                    break;
                }
                case 3: {
