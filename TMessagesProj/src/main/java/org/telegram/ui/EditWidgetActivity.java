...
public class EditWidgetActivity extends BaseFragment {
    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        public WidgetPreviewCell(Context context) {
            ...
            chatActionCell.setCustomText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_WIDGETPREVIEW, R.string.WidgetPreview));
    ...
    public View createView(Context context) {
        ...
        if (widgetType == TYPE_CHATS) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_WIDGETCHATS, R.string.WidgetChats));
        } else {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_WIDGETSHORTCUTS, R.string.WidgetShortcuts));
        }
        ActionBarMenu menu = actionBar.createMenu();
        menu.addItem(done_item, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DONE, R.string.Done).toUpperCase());
        ...
        listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListenerExtended() {
            ...
            public boolean onItemClick(View view, int position, float x, float y) {
                ...
                if (!rect.contains((int) x, (int) y)) {
                    ...
                    CharSequence[] items = new CharSequence[]{LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETE, R.string.Delete)};
            ...
            switch (holder.getItemViewType()) {
                case 0: {
                    ...
                    if (position == infoRow) {
                        ...
                        if (widgetType == TYPE_CHATS) {
                            builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_EDITWIDGETCHATSINFO, R.string.EditWidgetChatsInfo));
                        } else if (widgetType == TYPE_CONTACTS) {
                            builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_EDITWIDGETCONTACTSINFO, R.string.EditWidgetContactsInfo));
                        }
                        if (SharedConfig.passcodeHash.length() > 0) {
                            builder.append("\n\n").append(AndroidUtilities.replaceTags(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_WIDGETPASSCODE2, R.string.WidgetPasscode2)));
                        }
                ...
                case 1: {
                    ...
                    cell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SELECTCHATS, R.string.SelectChats), combinedDrawable, chatsStartRow != -1);
