...
public class UnlockPremiumView extends FrameLayout {
    ...
    public UnlockPremiumView(@NonNull Context context, int type, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (type == TYPE_STICKERS) {
            descriptionTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UNLOCKPREMIUMSTICKERSDESCRIPTION, R.string.UnlockPremiumStickersDescription));
        } else if (type == TYPE_REACTIONS) {
            descriptionTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UNLOCKPREMIUMREACTIONSDESCRIPTION, R.string.UnlockPremiumReactionsDescription));
        }
        ...
        String text;
        if (type == TYPE_STICKERS) {
            text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UNLOCKPREMIUMSTICKERS, R.string.UnlockPremiumStickers);
        } else {
            text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UNLOCKPREMIUMREACTIONS, R.string.UnlockPremiumReactions);
        }
