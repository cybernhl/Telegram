...
public class WallpapersListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (currentType == TYPE_ALL) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHATBACKGROUND, R.string.ChatBackground));
        } else if (currentType == TYPE_CHANNEL_PATTERNS) {
            actionBar.setTitle("Channel Wallpaper");
        } else if (currentType == TYPE_COLOR) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SELECTCOLORTITLE, R.string.SelectColorTitle));
        }
        ...
        if (currentType == TYPE_ALL) {
            ...
            searchItem = menu.addItem(0, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
                ...
                public void onCaptionCleared() {
                    ...
                    searchItem.setSearchFieldHint(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SEARCHBACKGROUNDS, R.string.SearchBackgrounds));
                }
            });
            searchItem.setSearchFieldHint(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SEARCHBACKGROUNDS, R.string.SearchBackgrounds));
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (position == uploadImageRow) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETCHATBACKGROUNDSALERTTITLE, R.string.ResetChatBackgroundsAlertTitle));
                builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETCHATBACKGROUNDSALERT, R.string.ResetChatBackgroundsAlert));
        ...
        searchEmptyView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NORESULT, R.string.NoResult));
            ...
            switch (viewType) {
                ...
                case 1:
                    ...
                    horizontalListView.setOnItemClickListener((view1, position) -> {
                        String color = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BACKGROUNDSEARCHCOLOR, R.string.BackgroundSearchColor);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SEARCHBYCOLOR, R.string.SearchByColor));
                    break;
                }
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                case 0: {
                    ...
                    if (position == uploadImageRow) {
                        textCell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SELECTFROMGALLERY, R.string.SelectFromGallery), R.drawable.msg_photos, true);
                    } else if (position == setColorRow) {
                        textCell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SETCOLOR, R.string.SetColor), R.drawable.msg_palette, true);
                    } else if (position == resetRow) {
                        textCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETCHATBACKGROUNDS, R.string.ResetChatBackgrounds), false);
                ...
                case 3: {
                    ...
                    if (position == resetInfoRow) {
                        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETCHATBACKGROUNDSINFO, R.string.ResetChatBackgroundsInfo));
