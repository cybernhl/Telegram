...
public class PhotoAlbumPickerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (allowSearchImages) {
            menu.addItem(2, R.drawable.ic_ab_search).setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SEARCH, R.string.Search));
        }
        ...
        menuItem.addSubItem(1, R.drawable.msg_openin, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_OPENINEXTERNALAPP, R.string.OpenInExternalApp));
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GALLERY, R.string.Gallery));
        ...
        emptyView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NOPHOTOS, R.string.NoPhotos));
