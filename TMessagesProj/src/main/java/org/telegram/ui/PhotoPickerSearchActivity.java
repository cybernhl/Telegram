...
//        sizeNotifierFrameLayout.addView(imagesSearch.shadow, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 3, Gravity.BOTTOM | Gravity.LEFT, 0, 0, 0, 48));
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMAGESTAB2, R.string.ImagesTab2));
        scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIFSTAB2, R.string.GifsTab2));
