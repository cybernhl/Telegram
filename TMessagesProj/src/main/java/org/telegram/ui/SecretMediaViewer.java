    ...
    public void openMedia(MessageObject messageObject, PhotoViewer.PhotoViewerProvider provider, Runnable onOpen, Runnable onClose) {
        ...
        if (document != null) {
            ...
            if (MessageObject.isGifDocument(document)) {
                actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DISAPPEARINGGIF, R.string.DisappearingGif));
                ...
                actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DISAPPEARINGVIDEO, R.string.DisappearingVideo));
            ...
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DISAPPEARINGPHOTO, R.string.DisappearingPhoto));
