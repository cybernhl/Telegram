...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        if (currentType == 0) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADONMOBILEDATA, R.string.AutoDownloadOnMobileData));
        } else if (currentType == 1) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADONWIFIDATA, R.string.AutoDownloadOnWiFiData));
        } else if (currentType == 2) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADONROAMINGDATA, R.string.AutoDownloadOnRoamingData));
        }
        ...
        listView.setOnItemClickListener((view, position, x, y) -> {
            if (position == autoDownloadRow) {
                ...
                if (position == storiesRow || (LocaleController.isRTL && x <= AndroidUtilities.dp(76) || !LocaleController.isRTL && x >= view.getMeasuredWidth() - AndroidUtilities.dp(76))) {
                    ...
                    if (position == photosRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADPHOTOSTITLE, R.string.AutoDownloadPhotosTitle));
                    } else if (position == videosRow) {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADVIDEOSTITLE, R.string.AutoDownloadVideosTitle));
                    } else {
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADFILESTITLE, R.string.AutoDownloadFilesTitle));
                    }
                    ...
                    for (int a = 0; a < 4; a++) {
                        ...
                        if (a == 0) {
                            cells[a].setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADCONTACTS, R.string.AutodownloadContacts), (currentPreset.mask[DownloadController.PRESET_NUM_CONTACT] & type) != 0, true);
                        } else if (a == 1) {
                            cells[a].setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADPRIVATECHATS, R.string.AutodownloadPrivateChats), (currentPreset.mask[DownloadController.PRESET_NUM_PM] & type) != 0, true);
                        } else if (a == 2) {
                            cells[a].setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADGROUPCHATS, R.string.AutodownloadGroupChats), (currentPreset.mask[DownloadController.PRESET_NUM_GROUP] & type) != 0, true);
                        } else {
                            cells[a].setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADCHANNELS, R.string.AutodownloadChannels), (currentPreset.mask[DownloadController.PRESET_NUM_CHANNEL] & type) != 0, position != photosRow);
                        }
                    ...
                    if (position != photosRow) {
                        ...
                        if (position == videosRow) {
                            sizeCell[0].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADMAXVIDEOSIZE, R.string.AutoDownloadMaxVideoSize));
                            checkCell[0].setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADPRELOADVIDEO, R.string.AutoDownloadPreloadVideo), currentPreset.preloadVideo, false);
                            ...
                            sizeCell[0].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADMAXFILESIZE, R.string.AutoDownloadMaxFileSize));
                            checkCell[0].setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADPRELOADMUSIC, R.string.AutoDownloadPreloadMusic), currentPreset.preloadMusic, false);
                            infoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADPRELOADMUSICINFO, R.string.AutoDownloadPreloadMusicInfo));
                        }
                    } else {
                        sizeCell[0] = null;
                        checkCell[0] = null;
                    ...
                    textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CANCEL, R.string.Cancel).toUpperCase());
                    ...
                    textView.setGravity(Gravity.CENTER);
                    textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
                    textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SAVE, R.string.Save).toUpperCase());
                    textView.setPadding(AndroidUtilities.dp(10), 0, AndroidUtilities.dp(10), 0);
            ...
            switch (holder.getItemViewType()) {
                case 0: {
                    ...
                    if (position == autoDownloadRow) {
                        ...
                        view.setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADMEDIA, R.string.AutoDownloadMedia), typePreset.enabled, false);
                        view.setTag(typePreset.enabled ? Theme.key_windowBackgroundChecked : Theme.key_windowBackgroundUnchecked);
                ...
                case 2: {
                    ...
                    if (position == usageHeaderRow) {
                        view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADDATAUSAGE, R.string.AutoDownloadDataUsage));
                    } else if (position == typeHeaderRow) {
                        view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADTYPES, R.string.AutoDownloadTypes));
                    }
                    break;
                }
                case 3: {
                ...
                case 4: {
                    ...
                    if (position == photosRow) {
                        text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADPHOTOS, R.string.AutoDownloadPhotos);
                        type = DownloadController.AUTODOWNLOAD_TYPE_PHOTO;
                    } else if (position == videosRow) {
                        text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADVIDEOS, R.string.AutoDownloadVideos);
                        type = DownloadController.AUTODOWNLOAD_TYPE_VIDEO;
                    } else if (position == storiesRow) {
                        text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADSTORIES, R.string.AutoDownloadStories);
                        type = -1;
                        view.setDrawLine(false);
                    } else {
                        text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADFILES, R.string.AutoDownloadFiles);
                        type = DownloadController.AUTODOWNLOAD_TYPE_DOCUMENT;
                    }
                    if (currentType == 0) {
                    ...
                    if (position == storiesRow) {
                        ...
                        for (int a = 0; a < preset.mask.length; a++) {
                            if ((preset.mask[a] & type) != 0) {
                                ...
                                switch (a) {
                                    case 0:
                                        builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADCONTACTS, R.string.AutoDownloadContacts));
                                        break;
                                    case 1:
                                        builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADPM, R.string.AutoDownloadPm));
                                        break;
                                    case 2:
                                        builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADGROUPS, R.string.AutoDownloadGroups));
                                        break;
                                    case 3:
                                        builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADCHANNELS, R.string.AutoDownloadChannels));
                                        break;
                                }
                                count++;
                            }
                        ...
                        if (count == 4) {
                            builder.setLength(0);
                            if (position == photosRow) {
                                builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADONALLCHATS, R.string.AutoDownloadOnAllChats));
                            } else {
                            ...
                            builder.append(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADOFF, R.string.AutoDownloadOff));
                        } else {
                            if (position == photosRow) {
                ...
                case 5: {
                    ...
                    if (position == typeSectionRow) {
                        view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADAUDIOINFO, R.string.AutoDownloadAudioInfo));
                        ...
                        if (usageHeaderRow == -1) {
                            ...
                            if (currentType == 0) {
                                view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADONMOBILEDATAINFO, R.string.AutoDownloadOnMobileDataInfo));
                            } else if (currentType == 1) {
                                view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADONWIFIDATAINFO, R.string.AutoDownloadOnWiFiDataInfo));
                            } else if (currentType == 2) {
                                view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADONROAMINGDATAINFO, R.string.AutoDownloadOnRoamingDataInfo));
                            }
                            view.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_YES);
                        } else {
                            view.setBackgroundDrawable(Theme.getThemedDrawableByKey(mContext, R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
    ...
    private void updatePresetChoseView(SlideChooseView slideChooseView) {
        ...
        for (int i = 0; i < presets.size(); i++) {
            ...
            if (preset == lowPreset) {
                presetsStr[i] = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADLOW, R.string.AutoDownloadLow);
            } else if (preset == mediumPreset) {
                presetsStr[i] = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADMEDIUM, R.string.AutoDownloadMedium);
            } else if (preset == highPreset) {
                presetsStr[i] = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADHIGH, R.string.AutoDownloadHigh);
            } else {
                presetsStr[i] = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODOWNLOADCUSTOM, R.string.AutoDownloadCustom);
            }
        }
