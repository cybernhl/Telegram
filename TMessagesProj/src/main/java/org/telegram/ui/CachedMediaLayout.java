...
public class CachedMediaLayout extends FrameLayout implements NestedSizeNotifierLayout.ChildLayout {
    ...
    public CachedMediaLayout(@NonNull Context context, BaseFragment parentFragment) {
        ...
        int CacheTabChats;
        allPages[PAGE_TYPE_CHATS] = new Page(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILTERCHATS, R.string.FilterChats), PAGE_TYPE_CHATS, new DialogsAdapter());
        //allPages[PAGE_TYPE_STORIES] = new Page(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILTERSTORIES, R.string.FilterStories), PAGE_TYPE_STORIES, new MediaAdapter(true));
        allPages[PAGE_TYPE_MEDIA] = new Page(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MEDIATAB, R.string.MediaTab), PAGE_TYPE_MEDIA, new MediaAdapter(false));
        allPages[PAGE_TYPE_DOCUMENTS] = new Page(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SHAREDFILESTAB2, R.string.SharedFilesTab2), PAGE_TYPE_DOCUMENTS, new DocumentsAdapter());
        allPages[PAGE_TYPE_MUSIC] = new Page(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MUSIC, R.string.Music), PAGE_TYPE_MUSIC, new MusicAdapter());
        //   allPages[PAGE_TYPE_VOICE] = new Page(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOICE, R.string.Voice), PAGE_TYPE_VOICE, new VoiceAdapter());
            ...
            public View createView(int viewType) {
                ...
                recyclerListView.setOnItemLongClickListener((view, position, x, y) -> {
                    ...
                    if (view instanceof CacheCell || view instanceof SharedPhotoVideoCell2) {
                        ...
                        if (view instanceof SharedPhotoVideoCell2) {
                            ActionBarMenuItem.addItem(popupWindowLayout, R.drawable.msg_view_file, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CACHEOPENFILE, R.string.CacheOpenFile), false, null).setOnClickListener(v -> {
                                openPhoto(itemInner, (MediaAdapter) adapter, recyclerListView, (SharedPhotoVideoCell2) view);
                                if (popupWindow != null) {
                                    popupWindow.dismiss();
                                }
                            ...
                            ActionBarMenuItem.addItem(popupWindowLayout, R.drawable.msg_played, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PLAYFILE, R.string.PlayFile), false, null).setOnClickListener(v -> {
                        ...
                        if (itemInner.file.dialogId != 0 && itemInner.file.messageId != 0) {
                            ActionBarMenuItem.addItem(popupWindowLayout, R.drawable.msg_viewintopic, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VIEWINCHAT, R.string.ViewInChat), false, null).setOnClickListener(v -> {
                        ...
                        ActionBarMenuItem.addItem(popupWindowLayout, R.drawable.msg_select,
                                !cacheModel.selectedFiles.contains(itemInner.file) ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SELECT, R.string.Select) : LocaleController.getString("Deselect", R.string.Deselect),
        ...
        clearItem.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETE, R.string.Delete));
...
//            }
            ...
            switch (holder.getItemViewType()) {
                case VIEW_TYPE_CHAT:
                    ...
                    if (dialogFileEntities.dialogId == UNKNOWN_CHATS_DIALOG_ID) {
                        title = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CACHEOTHERCHATS, R.string.CacheOtherChats);
    ...
    private class DocumentsAdapter extends BaseFilesAdapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            cell.setTextAndValueAndTypeAndThumb(file.messageType == MessageObject.TYPE_ROUND_VIDEO ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHROUND, R.string.AttachRound) : file.file.getName(), LocaleController.formatDateAudio(date / 1000, true), Utilities.getExtension(file.file.getName()), null, 0, divider);
            if (!animated) {
