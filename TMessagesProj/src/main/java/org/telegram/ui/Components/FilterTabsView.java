...
public class FilterTabsView extends FrameLayout {
    ...
    public class TabView extends View {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                info.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.ACTION_LONG_CLICK, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCROPENMENU2, R.string.AccDescrOpenMenu2)));
            } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (!tabs.isEmpty()) {
            ...
            firstTab.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILTERALLCHATS, R.string.FilterAllChats));
            int tabWith = firstTab.getWidth(false);
            firstTab.setTitle(allTabsWidth > width ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILTERALLCHATSSHORT, R.string.FilterAllChatsShort) : LocaleController.getString("FilterAllChats", R.string.FilterAllChats));
    ...
    public void checkTabsCounter() {
        ...
        for (int a = 0, N = tabs.size(); a < N; a++) {
            ...
            if (oldWidth != width || invalidated) {
                ...
                requestLayout();
                allTabsWidth = 0;
                findDefaultTab().setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILTERALLCHATS, R.string.FilterAllChats));
                for (int b = 0; b < N; b++) {
