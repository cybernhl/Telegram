...
public class DownloadsInfoBottomSheet extends BottomSheet {
    ...
    public DownloadsInfoBottomSheet(Context context, BaseFragment parentFragment, boolean needFocus) {
        ...
        title.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DOWNLOADEDFILES, R.string.DownloadedFiles));
        ...
        storageBtn.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MANAGEDEVICESTORAGE, R.string.ManageDeviceStorage));
        ...
        clearBtn.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CLEARDOWNLOADSLIST, R.string.ClearDownloadsList));
