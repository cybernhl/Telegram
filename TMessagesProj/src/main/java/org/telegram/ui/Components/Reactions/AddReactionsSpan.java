...
public class AddReactionsSpan extends ReplacementSpan {
    ...
    public void makeLayout() {
        if (layout == null) {
            layout = new StaticLayout(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_REACTIONADDREACTIONSHINT, R.string.ReactionAddReactionsHint), textPaint, AndroidUtilities.displaySize.x, LocaleController.isRTL ? Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_NORMAL, 1, 0, false);
