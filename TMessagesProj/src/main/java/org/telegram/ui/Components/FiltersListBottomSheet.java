...
public class FiltersListBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FiltersListBottomSheet(DialogsActivity baseFragment, ArrayList<Long> selectedDialogs) {
        ...
        titleTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILTERCHOOSE, R.string.FilterChoose));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (position < dialogFilters.size()) {
                ...
                cell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CREATENEWFILTER, R.string.CreateNewFilter), combinedDrawable);
            }
        }
    }
}
