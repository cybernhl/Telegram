...
public class ScamDrawable extends Drawable {
    ...
    public ScamDrawable(int textSize, int type) {
        ...
        if (type == 0) {
            text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SCAMMESSAGE, R.string.ScamMessage);
        } else {
            text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FAKEMESSAGE, R.string.FakeMessage);
        }
    ...
    public void checkText() {
        String newText;
        if (currentType == 0) {
            newText = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SCAMMESSAGE, R.string.ScamMessage);
        } else {
            newText = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FAKEMESSAGE, R.string.FakeMessage);
        }
