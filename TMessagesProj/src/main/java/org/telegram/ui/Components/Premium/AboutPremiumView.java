...
public class AboutPremiumView extends LinearLayout {
    ...
    public AboutPremiumView(@NonNull Context context) {
        ...
        textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ABOUTPREMIUMTITLE, R.string.AboutPremiumTitle));
        addView(textView);
        ...
        description.setText(AndroidUtilities.replaceTags(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ABOUTPREMIUMDESCRIPTION, R.string.AboutPremiumDescription)));
        ...
        description2.setText(AndroidUtilities.replaceTags(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ABOUTPREMIUMDESCRIPTION2, R.string.AboutPremiumDescription2)));
