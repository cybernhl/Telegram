...
public class JoinToSendSettingsView extends LinearLayout {
    ...
    public JoinToSendSettingsView(Context context, TLRPC.Chat currentChat) {
        ...
        joinHeaderCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELSETTINGSJOINTITLE, R.string.ChannelSettingsJoinTitle));
...
//                        .setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("ChannelSettingsJoinToSendRestricted", R.string.ChannelSettingsJoinToSendRestricted, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_EDITADMINBANUSERS, R.string.EditAdminBanUsers))))
...
//            }
        ...
        joinToSendCell.setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELSETTINGSJOINTOSEND, R.string.ChannelSettingsJoinToSend), isJoinToSend, isJoinToSend);
...
//            }
        ...
        joinRequestCell.setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELSETTINGSJOINREQUEST, R.string.ChannelSettingsJoinRequest), isJoinRequest, false);
        ...
        joinToSendInfoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELSETTINGSJOINTOSENDINFO, R.string.ChannelSettingsJoinToSendInfo));
        addView(joinToSendInfoCell);

        joinRequestInfoCell = new TextInfoPrivacyCell(context);
        joinRequestInfoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELSETTINGSJOINREQUESTINFO, R.string.ChannelSettingsJoinRequestInfo));
