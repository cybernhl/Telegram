    ...
    public JoinCallByUrlAlert(final Context context, TLRPC.Chat chat) {
        ...
        if (call != null) {
            ...
            if (call.call.participants_count == 0) {
                infoTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NOONEJOINEDYET, R.string.NoOneJoinedYet));
            } else {
        ...
        if (ChatObject.isChannelOrGiga(chat)) {
            clearButton.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPCHANNELJOINVOICECHATURL, R.string.VoipChannelJoinVoiceChatUrl));
        } else {
            clearButton.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPGROUPJOINVOICECHATURL, R.string.VoipGroupJoinVoiceChatUrl));
        }
