...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public PhonebookShareAlert(BaseFragment parent, ContactsController.Contact contact, TLRPC.User user, Uri uri, File file, String phone, String firstName, String lastName, Theme.ResourcesProvider resourcesProvider) {
                                ...
                                if (i == 0) {
                                    try {
                                        ...
                                        if (AndroidUtilities.shouldShowClipboardToast()) {
                                            Toast.makeText(this.parentFragment.getParentActivity(), LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TEXTCOPIED, R.string.TextCopied), Toast.LENGTH_SHORT).show();
                                        }
                                    } catch (Exception e) {
                                        FileLog.e(e);
                                    }
                ...
                view.setOnLongClickListener(v -> {
                    ...
                    if (BulletinFactory.canShowBulletin(parentFragment)) {
                        if (item.type == 3) {
                            ...
                            if (item.type == 0) {
                                layout.textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PHONECOPIED, R.string.PhoneCopied));
                                layout.imageView.setImageResource(R.drawable.msg_calls);
                            } else if (item.type == 1) {
                                layout.textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_EMAILCOPIED, R.string.EmailCopied));
                                layout.imageView.setImageResource(R.drawable.msg_mention);
                            } else {
                                layout.textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TEXTCOPIED, R.string.TextCopied));
        ...
        if (isImport) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ADDCONTACTPHONEBOOKTITLE, R.string.AddContactPhonebookTitle));
        } else {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SHARECONTACTTITLE, R.string.ShareContactTitle));
        }
        ...
        if (isImport) {
            buttonTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ADDCONTACTPHONEBOOKTITLE, R.string.AddContactPhonebookTitle));
        } else {
            buttonTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SHARECONTACTTITLE, R.string.ShareContactTitle));
        }
        ...
        buttonTextView.setOnClickListener(v -> {
            if (isImport) {
                ...
                builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ADDCONTACTTITLE, R.string.AddContactTitle));
                ...
                builder.setItems(new CharSequence[]{
                        LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CREATENEWCONTACT, R.string.CreateNewContact),
                        LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ADDTOEXISTINGCONTACT, R.string.AddToExistingContact)
