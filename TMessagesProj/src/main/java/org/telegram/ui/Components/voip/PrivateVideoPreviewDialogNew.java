...
public abstract class PrivateVideoPreviewDialogNew extends FrameLayout implements VoIPService.StateListener {
    ...
    public PrivateVideoPreviewDialogNew(Context context, float startLocationX, float startLocationY) {
        ...
        positiveButton = new TextView(getContext()) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (positiveButtonDrawText) {
                    ...
                    canvas.drawText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPSHAREVIDEO, R.string.VoipShareVideo), xPos, yPos, positiveButton.getPaint());
                }
            }
        };
        ...
        positiveButton.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPSHAREVIDEO, R.string.VoipShareVideo));
        ...
        for (int i = 0; i < titles.length; i++) {
            String text;
            if (i == 0) {
                text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPPHONESCREEN, R.string.VoipPhoneScreen);
            } else if (i == 1) {
                text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPFRONTCAMERA, R.string.VoipFrontCamera);
            } else {
                text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPBACKCAMERA, R.string.VoipBackCamera);
            }
    ...
    private void createPages(FrameLayout container) {
        {
            ...
            textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPVIDEOPRIVATESCREENSHARING, R.string.VoipVideoPrivateScreenSharing));
