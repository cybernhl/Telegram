...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate, Theme.ResourcesProvider resourcesProvider) {
        ...
        pickerBottomLayout.cancelButton.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STOPALLLOCATIONSHARINGS, R.string.StopAllLocationSharings));
        ...
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CLOSE, R.string.Close).toUpperCase());
