...
//    private TextView degreesLabel;
    ...
    public CropRotationWheel(Context context) {
        ...
        mirrorButton.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCRMIRROR, R.string.AccDescrMirror));
        ...
        aspectRatioButton.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCRASPECTRATIO, R.string.AccDescrAspectRatio));
        ...
        rotation90Button.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCRROTATE, R.string.AccDescrRotate));
