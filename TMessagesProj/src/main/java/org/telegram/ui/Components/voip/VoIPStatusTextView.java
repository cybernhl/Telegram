...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public VoIPStatusTextView(@NonNull Context context, VoIPBackgroundProvider backgroundProvider) {
        ...
        badConnectionTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPWEAKNETWORK, R.string.VoipWeakNetwork));
        ...
        SpannableStringBuilder ssb = new SpannableStringBuilder(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPRECONNECTING, R.string.VoipReconnecting));
