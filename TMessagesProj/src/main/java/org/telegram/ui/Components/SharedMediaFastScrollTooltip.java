...
public class SharedMediaFastScrollTooltip extends FrameLayout {
    ...
    public SharedMediaFastScrollTooltip(Context context) {
        ...
        textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SHAREDMEDIAFASTSCROLLHINT, R.string.SharedMediaFastScrollHint));
