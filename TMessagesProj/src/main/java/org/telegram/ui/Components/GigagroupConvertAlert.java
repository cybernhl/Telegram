...
public class GigagroupConvertAlert extends BottomSheet {
    ...
    public GigagroupConvertAlert(final Context context, BaseFragment parentFragment) {
        ...
        percentTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTTITLE, R.string.GigagroupConvertTitle));
        ...
        for (int a = 0; a < 3; a++) {
            ...
            switch (a) {
                case 0:
                    textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTINFO1, R.string.GigagroupConvertInfo1));
                    break;
                case 1:
                    textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTINFO2, R.string.GigagroupConvertInfo2));
                    break;
                case 2:
                    textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTINFO3, R.string.GigagroupConvertInfo3));
                    break;
            }
        ...
        clearButton.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTPROCESSBUTTON, R.string.GigagroupConvertProcessButton));
        clearButton.background.setOnClickListener(v -> {
            dismiss();
            AlertDialog.Builder builder = new AlertDialog.Builder(context);
            builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTALERTTITLE, R.string.GigagroupConvertAlertTitle));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTALERTTEXT, R.string.GigagroupConvertAlertText)));
            builder.setPositiveButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTALERTCONVER, R.string.GigagroupConvertAlertConver), (dialogInterface, i) -> onCovert());
        ...
        cancelTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GIGAGROUPCONVERTCANCELBUTTON, R.string.GigagroupConvertCancelButton));
