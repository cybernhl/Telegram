...
public class ImportingAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ImportingAlert(final Context context, String shortName, ChatActivity chatActivity, Theme.ResourcesProvider resourcesProvider) {
        ...
        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTDONE, R.string.ImportDone));
        ...
        for (int a = 0; a < 2; a++) {
            ...
            if (a == 0) {
                infoTextView[a].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTIMPORTINGINFO, R.string.ImportImportingInfo));
            } else {
        ...
        if (parentFragment != null) {
            textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTIMPORTINGTITLE, R.string.ImportImportingTitle));
            ...
            infoTextView[1].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTDONEINFO, R.string.ImportDoneInfo));
            importCountTextView[1].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTDONETITLE, R.string.ImportDoneTitle));

            parentFragment.getNotificationCenter().addObserver(this, NotificationCenter.historyImportProgressChanged);
        } else {
            textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTSTICKERSIMPORTINGTITLE, R.string.ImportStickersImportingTitle));
            ...
            infoTextView[1].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTSTICKERSDONEINFO, R.string.ImportStickersDoneInfo));
            importCountTextView[1].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTSTICKERSDONETITLE, R.string.ImportStickersDoneTitle));
