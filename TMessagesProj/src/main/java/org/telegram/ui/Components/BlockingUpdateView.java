...
public class BlockingUpdateView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BlockingUpdateView(final Context context) {
        ...
        titleTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UPDATETELEGRAM, R.string.UpdateTelegram));
    ...
    public void show(int account, TLRPC.TL_help_appUpdate update, boolean check) {
        ...
        if (update.document instanceof TLRPC.TL_document) {
            acceptTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UPDATE, R.string.Update) + String.format(Locale.US, " (%1$s)", AndroidUtilities.formatFileSize(update.document.size)));
        } else {
            acceptTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UPDATE, R.string.Update));
        }
