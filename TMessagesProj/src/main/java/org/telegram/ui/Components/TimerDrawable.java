        ...
        if (time != value) {
            ...
            if (time >= 1 && time < 60) {
                ...
                if (timeString.length() < 2) {
                    timeString += LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SECRETCHATTIMERSECONDS, R.string.SecretChatTimerSeconds);
                }
            } else if (time >= 60 && time < 60 * 60) {
                timeString = "" + value / 60;
                if (timeString.length() < 2) {
                    timeString += LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SECRETCHATTIMERMINUTES, R.string.SecretChatTimerMinutes);
                }
            } else if (time >= 60 * 60 && time < 60 * 60 * 24) {
                timeString = "" + value / 60 / 60;
                if (timeString.length() < 2) {
                    timeString += LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SECRETCHATTIMERHOURS, R.string.SecretChatTimerHours);
                }
            } else if (time >= 60 * 60 * 24 && time < 60 * 60 * 24 * 7) {
                timeString = "" + value / 60 / 60 / 24;
                if (timeString.length() < 2) {
                    timeString += LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SECRETCHATTIMERDAYS, R.string.SecretChatTimerDays);
                }
            } else if (time < 60 * 60 * 24 * 31) {
                timeString = "" + value / 60 / 60 / 24 / 7;
                if (timeString.length() < 2) {
                    timeString += LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SECRETCHATTIMERWEEKS, R.string.SecretChatTimerWeeks);
                ...
                if (timeString.length() < 2) {
                    timeString += LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SECRETCHATTIMERMONTHS, R.string.SecretChatTimerMonths);
                }
            } else {
                timeString = "" + value / 60 / 60 / 24 / 364;
                if (timeString.length() < 2) {
                    timeString += LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SECRETCHATTIMERYEARS, R.string.SecretChatTimerYears);
                }
            }
