...
public class AcceptDeclineView extends View {
    ...
    public AcceptDeclineView(@NonNull Context context) {
        ...
        String acceptStr = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCEPTCALL, R.string.AcceptCall);
        String declineStr = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DECLINECALL, R.string.DeclineCall);
        String retryStr = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RETRYCALL, R.string.RetryCall);
