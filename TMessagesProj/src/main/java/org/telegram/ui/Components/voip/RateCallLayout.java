...
public class RateCallLayout extends FrameLayout {
    ...
    public static class RateCallContainer extends FrameLayout {
        ...
        public RateCallContainer(@NonNull Context context, VoIPBackgroundProvider backgroundProvider) {
            ...
            titleTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPRATECALLTITLE, R.string.VoipRateCallTitle));
            ...
            messageTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPRATECALLDESCRIPTION, R.string.VoipRateCallDescription));
