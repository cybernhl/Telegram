...
public class ReadAllMentionsMenu {
    ...
    public static ActionBarPopupWindow show(int type, Activity activity, INavigationLayout navigationLayout, FrameLayout contentView, View mentionButton, Theme.ResourcesProvider resourcesProvider, Runnable onRead) {
        ...
        cell.setTextAndIcon(type == TYPE_REACTIONS ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_READALLREACTIONS, R.string.ReadAllReactions) : LocaleController.getString("ReadAllMentions", R.string.ReadAllMentions) , R.drawable.msg_seen);
