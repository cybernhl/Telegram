...
public class PhotoAttachPermissionCell extends FrameLayout {
    ...
    public void setType(int type) {
        if (type == 0) {
            ...
            textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CAMERAPERMISSIONTEXT, R.string.CameraPermissionText));
            ...
            textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GALLERYPERMISSIONTEXT, R.string.GalleryPermissionText));
