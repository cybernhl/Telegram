...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, Theme.ResourcesProvider resourcesProvider, int option) {
        ...
        premiumButtonView.setButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UNLOCK, R.string.Unlock), e -> onPremiumButtonClick());
        try {
    ...
    public void updateButtonState(int state, boolean animated) {
        ...
        if (state == BUTTON_STATE_LOCKED) {
            ...
            premiumButtonView.setButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESTORE, R.string.Restore), e -> onPremiumButtonClick());
        }
