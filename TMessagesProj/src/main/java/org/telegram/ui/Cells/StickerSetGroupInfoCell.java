...
public class StickerSetGroupInfoCell extends LinearLayout {
    ...
    public StickerSetGroupInfoCell(Context context) {
        ...
        infoTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GROUPSTICKERSINFO, R.string.GroupStickersInfo));
        ...
        addButton.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHOOSESTICKERSET, R.string.ChooseStickerSet).toUpperCase());
