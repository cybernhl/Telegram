...
public class FeaturedStickerSetCell2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FeaturedStickerSetCell2(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        delButton.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STICKERSREMOVE, R.string.StickersRemove));
        ...
        unlockButton.setButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_UNLOCK, R.string.Unlock), e -> onPremiumButtonClick());
