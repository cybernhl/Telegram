    ...
    public ArchiveHintInnerCell(Context context, int num) {
        ...
        switch (num) {
            case 0: {
                ...
                headerTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEHINTHEADER1, R.string.ArchiveHintHeader1));
                messageTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEHINTTEXT1, R.string.ArchiveHintText1));
            ...
            case 1:
                ...
                headerTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEHINTHEADER2, R.string.ArchiveHintHeader2));
                messageTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEHINTTEXT2, R.string.ArchiveHintText2));
                imageView.setImageResource(R.drawable.chats_archive_muted);
                break;
            case 2:
                addView(imageView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 18, 0, 0));

                headerTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEHINTHEADER3, R.string.ArchiveHintHeader3));
                messageTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEHINTTEXT3, R.string.ArchiveHintText3));
