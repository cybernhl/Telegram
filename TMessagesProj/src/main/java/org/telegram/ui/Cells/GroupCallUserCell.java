...
public class GroupCallUserCell extends FrameLayout {
        ...
        for (int a = 0; a < statusTextView.length; a++) {
            ...
            if (a == 4) {
                ...
                if (a == 0) {
                    ...
                    statusTextView[a].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LISTENING, R.string.Listening));
                } else if (a == 1) {
                    statusTextView[a].setTextColor(Theme.getColor(Theme.key_voipgroup_speakingText));
                    statusTextView[a].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SPEAKING, R.string.Speaking));
                    ...
                    statusTextView[a].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPGROUPMUTEDFORME, R.string.VoipGroupMutedForMe));
                } else if (a == 3) {
                    statusTextView[a].setTextColor(Theme.getColor(Theme.key_voipgroup_listeningText));
                    statusTextView[a].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_WANTSTOSPEAK, R.string.WantsToSpeak));
                }
    ...
    private void applyParticipantChanges(boolean animated, boolean internal) {
        ...
        if (isSelfUser()) {
            if (!hasAbout && !hasAvatar) {
                if (currentUser != null) {
                    statusTextView[4].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TAPTOADDPHOTOORBIO, R.string.TapToAddPhotoOrBio));
                } else {
                    statusTextView[4].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TAPTOADDPHOTOORDESCRIPTION, R.string.TapToAddPhotoOrDescription));
                }
                statusTextView[4].setTextColor(Theme.getColor(grayIconColor));
            } else if (!hasAbout ){
                if (currentUser != null) {
                    statusTextView[4].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TAPTOADDBIO, R.string.TapToAddBio));
                } else {
                    statusTextView[4].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TAPTOADDDESCRIPTION, R.string.TapToAddDescription));
                }
                statusTextView[4].setTextColor(Theme.getColor(grayIconColor));
            } else if (!hasAvatar) {
                statusTextView[4].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TAPTOADDPHOTO, R.string.TapToAddPhoto));
                statusTextView[4].setTextColor(Theme.getColor(grayIconColor));
            } else {
                statusTextView[4].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_THISISYOU, R.string.ThisIsYou));
        ...
        if (newStatus == 1) {
            ...
            if (volume != 100) {
                ...
                statusTextView[1].setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SPEAKING, R.string.Speaking));
            }
        }
        if (isSelfUser()) {
            applyStatus(4);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (info.isEnabled() && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            info.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.ACTION_CLICK, participant.muted && !participant.can_self_unmute ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPUNMUTE, R.string.VoipUnmute) : LocaleController.getString("VoipMute", R.string.VoipMute)));
        }
    }
