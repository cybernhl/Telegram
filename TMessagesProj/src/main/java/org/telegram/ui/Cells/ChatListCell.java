...
public class ChatListCell extends LinearLayout {
    ...
    private class ListView extends FrameLayout {
        ...
        public ListView(Context context, boolean threeLines) {
            ...
            setContentDescription(threeLines ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHATLISTEXPANDED, R.string.ChatListExpanded) : LocaleController.getString("ChatListDefault", R.string.ChatListDefault));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            String text = isThreeLines ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHATLISTEXPANDED, R.string.ChatListExpanded) : LocaleController.getString("ChatListDefault", R.string.ChatListDefault);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            info.setContentDescription(isThreeLines ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHATLISTEXPANDED, R.string.ChatListExpanded) : LocaleController.getString("ChatListDefault", R.string.ChatListDefault));
        }
    }
