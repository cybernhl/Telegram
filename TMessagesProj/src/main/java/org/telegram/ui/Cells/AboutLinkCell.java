...
public class AboutLinkCell extends FrameLayout {
    ...
    public AboutLinkCell(Context context, BaseFragment fragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        showMoreTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DESCRIPTIONMORE, R.string.DescriptionMore));
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_OPEN, R.string.Open), LocaleController.getString("Copy", R.string.Copy)}, (dialog, which) -> {
                    if (which == 0) {
                        ...
                        if (AndroidUtilities.shouldShowClipboardToast()) {
                            if (url.startsWith("@")) {
                                BulletinFactory.of(parentFragment).createSimpleBulletin(R.raw.copy, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMECOPIED, R.string.UsernameCopied)).show();
                            } else if (url.startsWith("#") || url.startsWith("$")) {
                                BulletinFactory.of(parentFragment).createSimpleBulletin(R.raw.copy, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_HASHTAGCOPIED, R.string.HashtagCopied)).show();
                            } else {
                                BulletinFactory.of(parentFragment).createSimpleBulletin(R.raw.copy, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKCOPIED, R.string.LinkCopied)).show();
                            }
                        }
                    }
                });
