...
//        radioButton.setOverrideColorProgress(cx, cy, animatedRad);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setContentDescription(radioButton.isChecked() ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NOTIFICATIONSON, R.string.NotificationsOn) : LocaleController.getString("NotificationsOff", R.string.NotificationsOff));
