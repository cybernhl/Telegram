...
public class SessionBottomSheet extends BottomSheet {
    ...
    public SessionBottomSheet(BaseFragment fragment, TLRPC.TL_authorization session, boolean isCurrentSession, Callback callback) {
        ...
        applicationItemView.descriptionText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_APPLICATION, R.string.Application));
        ...
        if (session.country.length() != 0) {
            ...
            locationItemView.descriptionText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCATION, R.string.Location));
        ...
        if (session.ip.length() != 0) {
            ...
            drawable.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_windowBackgroundWhiteGrayIcon), PorterDuff.Mode.SRC_IN));
            locationItemView.iconView.setImageDrawable(drawable);
            locationItemView.descriptionText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IPADDRESS, R.string.IpAddress));
        ...
        if (secretChatsEnabled(session)) {
            ...
            acceptSecretChats.valueText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCEPTSECRETCHATS, R.string.AcceptSecretChats));
            ...
            acceptSecretChats.descriptionText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCEPTSECRETCHATSDESCRIPTION, R.string.AcceptSecretChatsDescription));
            linearLayout.addView(acceptSecretChats);
            prevItem = acceptSecretChats;
        }

        ItemView acceptCalls = new ItemView(context, true);
        acceptCalls.valueText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCEPTCALLS, R.string.AcceptCalls));
        ...
        acceptCalls.descriptionText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCEPTCALLSCHATSDESCRIPTION, R.string.AcceptCallsChatsDescription));
        ...
        if (!isCurrentSession) {
            ...
            buttonTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TERMINATESESSION, R.string.TerminateSession));
    ...
    private void copyText(String text) {
        ...
        builder.setItems(new CharSequence[]{LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_COPY, R.string.Copy)}, (dialogInterface, i) -> {
            android.content.ClipboardManager clipboard = (android.content.ClipboardManager) ApplicationLoader.applicationContext.getSystemService(Context.CLIPBOARD_SERVICE);
            android.content.ClipData clip = android.content.ClipData.newPlainText("label", text);
            clipboard.setPrimaryClip(clip);
            BulletinFactory.of(getContainer(), null).createCopyBulletin(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TEXTCOPIED, R.string.TextCopied)).show();
        });
        builder.show();
    ...
    private static class ItemView extends FrameLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            if (switchView != null) {
                ...
                info.setText(valueText.getText() + "\n" + descriptionText.getText() + "\n" + (switchView.isChecked() ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NOTIFICATIONSON, R.string.NotificationsOn) : LocaleController.getString("NotificationsOff", R.string.NotificationsOff)));
            }
        }
    }
