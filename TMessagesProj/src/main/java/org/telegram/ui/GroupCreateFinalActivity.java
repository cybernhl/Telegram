...
public class GroupCreateFinalActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NEWGROUP, R.string.NewGroup));
        ...
        avatarImage.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHOOSEPHOTO, R.string.ChoosePhoto));
        ...
        editText.setHint(chatType == ChatObject.CHAT_TYPE_CHAT || chatType == ChatObject.CHAT_TYPE_MEGAGROUP || chatType == ChatObject.CHAT_TYPE_FORUM ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENTERGROUPNAMEPLACEHOLDER, R.string.EnterGroupNamePlaceholder) : LocaleController.getString("EnterListName", R.string.EnterListName));
        if (nameToSet != null) {
    ...
    public class GroupCreateAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void notifyDataSetChanged() {
            ...
            if (chatType == ChatObject.CHAT_TYPE_FORUM) {
                ...
                items.add(new InnerItem(VIEW_TYPE_TEXT_INFO_CELL, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FORUMTOGGLEDESCRIPTION, R.string.ForumToggleDescription)));
            } else {
                items.add(new InnerItem(VIEW_TYPE_AUTO_DELETE));
                items.add(new InnerItem(VIEW_TYPE_TEXT_INFO_CELL, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GROUPCREATEAUTODELETEDESCRIPTION, R.string.GroupCreateAutodeleteDescription)));
            }
            ...
            switch (holder.getItemViewType()) {
                case VIEW_TYPE_HEADER_CELL: {
                    ...
                    if (currentGroupCreateAddress != null && position == 1) {
                        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHLOCATION, R.string.AttachLocation));
                    } else {
                ...
                case VIEW_TYPE_AUTO_DELETE: {
                    ...
                    textCell.setTextAndValueAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODELETEMESSAGES, R.string.AutoDeleteMessages), value, fragmentBeginToShow, R.drawable.msg_autodelete, false);
                    break;
                }
                case VIEW_TYPE_TOPICS: {
                    TextCell textCell = (TextCell) holder.itemView;
                    textCell.setTextAndCheckAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELTOPICS, R.string.ChannelTopics), true, R.drawable.msg_topics, false);
