...
public class PopupNotificationActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 3) {
            ...
            builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_PERMISSIONNOAUDIOWITHHINT, R.string.PermissionNoAudioWithHint));
    ...
    private void updateSubtitle() {
        ...
        if (currentUser != null && currentUser.id == 777000) {
            onlineTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SERVICENOTIFICATIONS, R.string.ServiceNotifications));
        } else {
