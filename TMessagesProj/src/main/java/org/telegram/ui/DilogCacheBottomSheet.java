    ...
    public DilogCacheBottomSheet(CacheControlActivity baseFragment, CacheControlActivity.DialogFileEntities entities, CacheModel cacheModel, Delegate delegate) {
        ...
        for (int a = 0; a < 8; a++) {
            ...
            if (a == CacheControlActivity.TYPE_PHOTOS) {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALPHOTOCACHE, R.string.LocalPhotoCache);
                color = Theme.key_statisticChartLine_lightblue;
            } else if (a == CacheControlActivity.TYPE_VIDEOS) {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALVIDEOCACHE, R.string.LocalVideoCache);
                color = Theme.key_statisticChartLine_blue;
            } else if (a == CacheControlActivity.TYPE_DOCUMENTS) {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALDOCUMENTCACHE, R.string.LocalDocumentCache);
                color = Theme.key_statisticChartLine_green;
            } else if (a == CacheControlActivity.TYPE_MUSIC) {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALMUSICCACHE, R.string.LocalMusicCache);
                color = Theme.key_statisticChartLine_red;
            } else if (a == CacheControlActivity.TYPE_VOICE) {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALAUDIOCACHE, R.string.LocalAudioCache);
                color = Theme.key_statisticChartLine_lightgreen;
            } else if (a == CacheControlActivity.TYPE_ANIMATED_STICKERS_CACHE) {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALSTICKERSCACHE, R.string.LocalStickersCache);
                color = Theme.key_statisticChartLine_orange;
            } else if (a == CacheControlActivity.TYPE_STORIES) {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALSTORIESCACHE, R.string.LocalStoriesCache);
                color = Theme.key_statisticChartLine_indigo;
            } else {
                name = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOCALMISCELLANEOUSCACHE, R.string.LocalMiscellaneousCache);
...
//                    }
    ...
    private void createButton() {
        ...
        button.button.setOnClickListener(v -> {
            ...
            builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CLEARCACHEFORCHAT, R.string.ClearCacheForChat));
            builder.setNegativeButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CANCEL, R.string.Cancel), (di, which) -> {
                dismiss();
            });
