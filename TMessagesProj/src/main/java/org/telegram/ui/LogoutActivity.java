...
public class LogoutActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOGOUTTITLE, R.string.LogOutTitle));
    ...
    public static AlertDialog makeLogOutDialog(Context context, int currentAccount) {
        ...
        builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AREYOUSURELOGOUT, R.string.AreYouSureLogout));
        builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOGOUT, R.string.LogOut));
        builder.setPositiveButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOGOUT, R.string.LogOut), (dialogInterface, i) -> MessagesController.getInstance(currentAccount).performLogout(1));
            ...
            switch (holder.getItemViewType()) {
                case 0: {
                    ...
                    if (position == alternativeHeaderRow) {
                        view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ALTERNATIVEOPTIONS, R.string.AlternativeOptions));
                    }
                    break;
                }
                case 1: {
                    ...
                    if (position == addAccountRow) {
                        view.setTextAndValueAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ADDANOTHERACCOUNT, R.string.AddAnotherAccount), LocaleController.getString("AddAnotherAccountInfo", R.string.AddAnotherAccountInfo), R.drawable.msg_contact_add, true);
                    } else if (position == passcodeRow) {
                        view.setTextAndValueAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SETPASSCODE, R.string.SetPasscode), LocaleController.getString("SetPasscodeInfo", R.string.SetPasscodeInfo), R.drawable.msg_permissions, true);
                    } else if (position == cacheRow) {
                        view.setTextAndValueAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CLEARCACHE, R.string.ClearCache), LocaleController.getString("ClearCacheInfo", R.string.ClearCacheInfo), R.drawable.msg_clearcache, true);
                    } else if (position == phoneRow) {
                        view.setTextAndValueAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANGEPHONENUMBER, R.string.ChangePhoneNumber), LocaleController.getString("ChangePhoneNumberInfo", R.string.ChangePhoneNumberInfo), R.drawable.msg_newphone, true);
                    } else if (position == supportRow) {
                        view.setTextAndValueAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CONTACTSUPPORT, R.string.ContactSupport), LocaleController.getString("ContactSupportInfo", R.string.ContactSupportInfo), R.drawable.msg_help, false);
                    }
                    break;
                }
                case 3: {
                    ...
                    if (position == logoutRow) {
                        ...
                        view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOGOUTTITLE, R.string.LogOutTitle), false);
                    }
                    break;
                }
                case 4: {
                    ...
                    if (position == logoutSectionRow) {
                        view.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LOGOUTINFO, R.string.LogOutInfo));
                    }
                    break;
                }
            }
