...
//        }
        ...
        forever = ActionBarMenuItem.addItem(this, R.drawable.msg_cancel, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTODELETEMEDIANEVER, R.string.AutoDeleteMediaNever), false, null);
        delete = ActionBarMenuItem.addItem(this, R.drawable.msg_delete, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETEEXCEPTION, R.string.DeleteException), false, null);
        ...
        description.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_KEEPMEDIAPOPUPDESCRIPTION, R.string.KeepMediaPopupDescription));
    ...
    public void update(int type) {
        ...
        if (exceptions.isEmpty()) {
            exceptionsView.titleView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ADDANEXCEPTION, R.string.AddAnException));
