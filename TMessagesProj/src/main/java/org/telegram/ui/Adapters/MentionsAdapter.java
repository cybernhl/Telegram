...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
        ...
        if (user != null && user.bot && user.bot_inline_placeholder != null) {
            ...
            if (foundContextBot.bot_inline_geo) {
                ...
                if (!allowGeo && parentFragment != null && parentFragment.getParentActivity() != null) {
                    ...
                    builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SHAREYOULOCATIONINLINE, R.string.ShareYouLocationInline));
    ...
    public String getBotCaption() {
        if (foundContextBot != null) {
            ...
            return LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SEARCHGIFSTITLE, R.string.SearchGifsTitle);
        }
        return null;
    }
        ...
        if (type == 4) {
            ...
            if (chat != null) {
                if (!ChatObject.hasAdminRights(chat) && chat.default_banned_rights != null && chat.default_banned_rights.send_inline) {
                    textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GLOBALATTACHINLINERESTRICTED, R.string.GlobalAttachInlineRestricted));
                } else if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                    textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ATTACHINLINERESTRICTEDFOREVER, R.string.AttachInlineRestrictedForever));
                } else {
