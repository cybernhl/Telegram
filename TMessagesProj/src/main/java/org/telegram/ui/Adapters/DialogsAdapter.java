    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_RECENTLY_VIEWED: {
                ...
                headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RECENTLYVIEWED, R.string.RecentlyViewed));

                TextView textView = new TextView(mContext);
                textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 15);
                textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
                textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader));
                textView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RECENTLYVIEWEDHIDE, R.string.RecentlyViewedHide));
        ...
        switch (holder.getItemViewType()) {
                    ...
                    if (chat != null) {
                        ...
                        if (user != null) {
                            ...
                            if (!UserObject.isReplyUser(user)) {
                                if (user.bot) {
                                    subtitle = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BOT, R.string.Bot);
                                } else {
            ...
            case VIEW_TYPE_HEADER: {
                ...
                if (
                    ...
                    if (i == 0) {
                        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTHEADER, R.string.ImportHeader));
                    } else {
                        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_IMPORTHEADERCONTACTS, R.string.ImportHeaderContacts));
                    }
                } else {
            ...
            case VIEW_TYPE_HEADER_2: {
                ...
                switch (((DialogsActivity.DialogsHeader) getItem(i)).headerType) {
                    case DialogsActivity.DialogsHeader.HEADER_TYPE_MY_CHANNELS:
                        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MYCHANNELS, R.string.MyChannels));
                        break;
                    case DialogsActivity.DialogsHeader.HEADER_TYPE_MY_GROUPS:
                        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MYGROUPS, R.string.MyGroups));
                        break;
                    case DialogsActivity.DialogsHeader.HEADER_TYPE_GROUPS:
                        cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_FILTERGROUPS, R.string.FilterGroups));
                        break;
                }
                break;
            }
            case VIEW_TYPE_NEW_CHAT_HINT: {
                ...
                cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TAPONTHEPENCIL, R.string.TapOnThePencil));
                if (arrowDrawable == null) {
            ...
            case VIEW_TYPE_TEXT: {
                ...
                if (requestPeerType != null) {
                    if (requestPeerType instanceof TLRPC.TL_requestPeerTypeBroadcast) {
                        cell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CREATECHANNELFORTHIS, R.string.CreateChannelForThis), R.drawable.msg_channel_create, true);
                    } else {
                        cell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CREATEGROUPFORTHIS, R.string.CreateGroupForThis), R.drawable.msg_groups_create, true);
                    }
                } else {
                    cell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CREATEGROUPFORIMPORT, R.string.CreateGroupForImport), R.drawable.msg_groups_create, dialogsCount != 0);
                }
                cell.setIsInDialogs();
