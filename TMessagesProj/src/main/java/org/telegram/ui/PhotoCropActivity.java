...
public class PhotoCropActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CROPIMAGE, R.string.CropImage));
        ...
        menu.addItemWithWidth(done_button, R.drawable.ic_ab_done, AndroidUtilities.dp(56), LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DONE, R.string.Done));
