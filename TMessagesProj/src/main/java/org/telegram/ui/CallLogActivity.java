...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
	...
	private static class EmptyTextProgressView extends FrameLayout {
		...
		public EmptyTextProgressView(Context context, View progressView) {
			...
			emptyTextView1.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NORECENTCALLS, R.string.NoRecentCalls));
			...
			String help = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NORECENTCALLSINFO, R.string.NoRecentCallsInfo);
	...
	private class CallCell extends FrameLayout {
		...
		public CallCell(Context context) {
			...
			imageView.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CALL, R.string.Call));
	...
	private class GroupCallCell extends FrameLayout {
		...
		public GroupCallCell(Context context) {
			...
			String text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPCHATJOIN, R.string.VoipChatJoin);
	...
	public View createView(Context context) {
		...
		otherItem.addSubItem(delete_all_calls, R.drawable.msg_delete, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETEALLCALLS, R.string.DeleteAllCalls));
		...
		floatingButton.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CALL, R.string.Call));
		if (Build.VERSION.SDK_INT >= 21) {
	...
	private void showDeleteAlert(boolean all) {
		...
		if (all) {
			builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETEALLCALLS, R.string.DeleteAllCalls));
			builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETEALLCALLSTEXT, R.string.DeleteAllCallsText));
		} else {
			builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETECALLS, R.string.DeleteCalls));
			builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETESELECTEDCALLSTEXT, R.string.DeleteSelectedCallsText));
		}
		final boolean[] checks = new boolean[]{false};
		FrameLayout frameLayout = new FrameLayout(getParentActivity());
		CheckBoxCell cell = new CheckBoxCell(getParentActivity(), 1);
		cell.setBackgroundDrawable(Theme.getSelectorDrawable(false));
		cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DELETECALLSFOREVERYONE, R.string.DeleteCallsForEveryone), "", false, false);
			...
			switch (holder.getItemViewType()) {
				case 0: {
					...
					switch (row.type) {
						case TYPE_OUT:
							...
							//cell.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CALLMESSAGEOUTGOING, R.string.CallMessageOutgoing));
							break;
						case TYPE_IN:
							subtitle.setSpan(iconIn, ldir.length(), ldir.length() + 1, 0);
							//cell.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CALLMESSAGEINCOMING, R.string.CallMessageIncoming));
							break;
						case TYPE_MISSED:
							subtitle.setSpan(iconMissed, ldir.length(), ldir.length() + 1, 0);
							//cell.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CALLMESSAGEINCOMINGMISSED, R.string.CallMessageIncomingMissed));
							break;
					}
				...
				case 3: {
					...
					if (position == activeHeaderRow) {
						cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPCHATACTIVECHATS, R.string.VoipChatActiveChats));
					} else if (position == callsHeaderRow) {
						cell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_VOIPCHATRECENTCALLS, R.string.VoipChatRecentCalls));
					}
					break;
				}
				case 4: {
					...
					if (ChatObject.isChannel(chat) && !chat.megagroup) {
						if (!ChatObject.isPublic(chat)) {
							text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELPRIVATE, R.string.ChannelPrivate).toLowerCase();
						} else {
							text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELPUBLIC, R.string.ChannelPublic).toLowerCase();
						}
					} else {
						if (chat.has_geo) {
							text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MEGALOCATION, R.string.MegaLocation);
						} else if (!ChatObject.isPublic(chat)) {
							text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MEGAPRIVATE, R.string.MegaPrivate).toLowerCase();
						} else {
							text = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MEGAPUBLIC, R.string.MegaPublic).toLowerCase();
						}
					}
