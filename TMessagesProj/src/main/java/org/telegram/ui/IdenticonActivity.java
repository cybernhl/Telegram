...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENCRYPTIONKEY, R.string.EncryptionKey));
        ...
        if (encryptedChat != null) {
            ...
            if (index != -1) {
                hash.setSpan(new URLSpanReplacement(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENCRYPTIONKEYLINK, R.string.EncryptionKeyLink)), index, index + url.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
