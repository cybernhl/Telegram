...
public class DataUsage2Activity extends BaseFragment {
    ...
    private class PageAdapter extends ViewPagerFixed.Adapter {
        ...
        public String getItemTitle(int position) {
            switch (position) {
                case ListView.TYPE_ALL:     return LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGEALLTAB, R.string.NetworkUsageAllTab);
                case ListView.TYPE_MOBILE:  return LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGEMOBILETAB, R.string.NetworkUsageMobileTab);
                case ListView.TYPE_WIFI:    return LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGEWIFITAB, R.string.NetworkUsageWiFiTab);
                case ListView.TYPE_ROAMING: return LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NETWORKUSAGEROAMINGTAB, R.string.NetworkUsageRoamingTab);
                default: return "";
            }
        }
    }
        ...
        public ListView(Context context) {
            ...
            setOnItemClickListener((view, position) -> {
                if (view instanceof Cell && position >= 0 && position < itemInners.size()) {
                    ...
                    builder.setPositiveButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESET, R.string.Reset), (dialogInterface, j) -> {
                    ...
                    if (index >= 0 && !collapsed[index]) {
                        ...
                        if (stats[size.index] == StatsController.TYPE_CALLS) {
                            ...
                            if (size.outSize > 0 || size.outCount > 0) {
                                sections.add(++i, ItemInner.asCell(
                                        -1, 0, 0,
                                        TextUtils.concat(sentIcon, " ", LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BYTESSENT, R.string.BytesSent)),
                                        AndroidUtilities.formatFileSize(size.outSize)
                                ));
                            }
                            if (size.inSize > 0 || size.inCount > 0) {
                                sections.add(++i, ItemInner.asCell(
                                        -1, 0, 0,
                                        TextUtils.concat(receivedIcon, " ", LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BYTESRECEIVED, R.string.BytesReceived)),
                                        AndroidUtilities.formatFileSize(size.inSize)
                                ));
                            }
                        }
...
//                itemInners.add(new ItemInner(VIEW_TYPE_END));
                if (!empty) {
                    itemInners.add(ItemInner.asSeparator(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DATAUSAGESECTIONSINFO, R.string.DataUsageSectionsInfo)));
                }
            }

            if (!empty) {
                itemInners.add(ItemInner.asHeader(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TOTALNETWORKUSAGE, R.string.TotalNetworkUsage)));
                itemInners.add(ItemInner.asCell(
                        -1,
                        R.drawable.msg_filled_data_sent,
                        getThemedColor(Theme.key_statisticChartLine_lightblue),
                        LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BYTESSENT, R.string.BytesSent),
                ...
                itemInners.add(ItemInner.asCell(
                        ...
                        LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BYTESRECEIVED, R.string.BytesReceived),
            ...
            if (currentType != TYPE_ALL) {
                ...
                itemInners.add(ItemInner.asCell(
                        ...
                        getThemedColor(Theme.key_statisticChartLine_lightblue),
                        LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTOMATICDOWNLOADSETTINGS, R.string.AutomaticDownloadSettings),
                        null
                ));
                String info;
                switch (currentType) {
                    case TYPE_MOBILE:
                        info = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTOMATICDOWNLOADSETTINGSINFOMOBILE, R.string.AutomaticDownloadSettingsInfoMobile);
                        break;
                    case TYPE_ROAMING:
                        info = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTOMATICDOWNLOADSETTINGSINFOROAMING, R.string.AutomaticDownloadSettingsInfoRoaming);
                        break;
                    default:
                    case TYPE_WIFI:
                        info = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AUTOMATICDOWNLOADSETTINGSINFOWIFI, R.string.AutomaticDownloadSettingsInfoWiFi);
                        break;
                }
            ...
            if (!sections.isEmpty()) {
                itemInners.add(new ItemInner(VIEW_TYPE_RESET_BUTTON, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETSTATISTICS, R.string.ResetStatistics)));
            }
            itemInners.add(ItemInner.asSeparator());
