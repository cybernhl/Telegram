...
//            }
    ...
    public void onResume() {
        ...
        if (textCell2 != null && info != null) {
            if (info.stickerset != null) {
                textCell2.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GROUPSTICKERS, R.string.GroupStickers), info.stickerset.title, false);
            } else {
                textCell2.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GROUPSTICKERS, R.string.GroupStickers), false);
            }
        }
        if (info != null) {
    ...
    public View createView(Context context) {
        ...
        doneButton = menu.addItemWithWidth(done_button, doneButtonDrawable, AndroidUtilities.dp(56), LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DONE, R.string.Done));
        ...
        if (isForcePublic) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TYPELOCATIONGROUP, R.string.TypeLocationGroup));
        } else if (isChannel) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELSETTINGSTITLE, R.string.ChannelSettingsTitle));
        } else {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GROUPSETTINGSTITLE, R.string.GroupSettingsTitle));
        }
        ...
        if (isChannel) {
            headerCell2.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELTYPEHEADER, R.string.ChannelTypeHeader));
        } else {
            headerCell2.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_GROUPTYPEHEADER, R.string.GroupTypeHeader));
        }
        ...
        if (isChannel) {
            radioButtonCell2.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELPRIVATE, R.string.ChannelPrivate), LocaleController.getString("ChannelPrivateInfo", R.string.ChannelPrivateInfo), false, isPrivate);
        } else {
            radioButtonCell2.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MEGAPRIVATE, R.string.MegaPrivate), LocaleController.getString("MegaPrivateInfo", R.string.MegaPrivateInfo), false, isPrivate);
        }
        ...
        if (isChannel) {
            radioButtonCell1.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELPUBLIC, R.string.ChannelPublic), LocaleController.getString("ChannelPublicInfo", R.string.ChannelPublicInfo), false, !isPrivate);
        } else {
            radioButtonCell1.setTextAndValue(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MEGAPUBLIC, R.string.MegaPublic), LocaleController.getString("MegaPublicInfo", R.string.MegaPublicInfo), false, !isPrivate);
        }
        ...
        usernameTextView.setHint(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELUSERNAMEPLACEHOLDER, R.string.ChannelUsernamePlaceholder));
        ...
        manageLinksTextView.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MANAGEINVITELINKS, R.string.ManageInviteLinks), R.drawable.msg_link2, false);
        ...
        saveHeaderCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SAVINGCONTENTTITLE, R.string.SavingContentTitle));
        ...
        saveRestrictCell.setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESTRICTSAVINGCONTENT, R.string.RestrictSavingContent), isSaveRestricted, false);
        ...
        if (isChannel && !ChatObject.isMegagroup(currentChat)) {
            saveRestrictInfoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESTRICTSAVINGCONTENTINFOCHANNEL, R.string.RestrictSavingContentInfoChannel));
        } else {
            saveRestrictInfoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESTRICTSAVINGCONTENTINFOGROUP, R.string.RestrictSavingContentInfoGroup));
        }
                ...
                public void onItemClick(View view, int position) {
                    if (view instanceof ChangeUsernameActivity.UsernameCell) {
                        ...
                        new AlertDialog.Builder(getContext(), getResourceProvider())
                            .setTitle(username.active ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMEDEACTIVATELINK, R.string.UsernameDeactivateLink) : LocaleController.getString("UsernameActivateLink", R.string.UsernameActivateLink))
                            .setMessage(username.active ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMEDEACTIVATELINKCHANNELMESSAGE, R.string.UsernameDeactivateLinkChannelMessage) : LocaleController.getString("UsernameActivateLinkChannelMessage", R.string.UsernameActivateLinkChannelMessage))
                            .setPositiveButton(username.active ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_HIDE, R.string.Hide) : LocaleController.getString("Show", R.string.Show), (di, e) -> {
                                if (username.editable) {
                                            ...
                                            if (res instanceof TLRPC.TL_boolTrue) {
                                                ...
                                                AndroidUtilities.runOnUIThread(() -> {
                                                    new AlertDialog.Builder(getContext(), resourcesProvider)
                                                        .setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMEACTIVATEERRORTITLE, R.string.UsernameActivateErrorTitle))
                                                        .setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMEACTIVATEERRORMESSAGE, R.string.UsernameActivateErrorMessage))
                                                        .setPositiveButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_OK, R.string.OK), (d, v) -> {
...
//                                toggleUsername(username, username.active);
                            ...
                            .setNegativeButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CANCEL, R.string.Cancel), (di, e) -> {
                                di.dismiss();
                            })
                            .show();
                    }
            ...
            public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
                switch (holder.getItemViewType()) {
                    case VIEW_TYPE_HEADER:
                        ...
                        ((HeaderCell) holder.itemView).setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMESCHANNELHEADER, R.string.UsernamesChannelHeader));
                        break;
                    case VIEW_TYPE_USERNAME:
                        TLRPC.TL_username username = usernames.get(position - 1);
                        ...
                        break;
                    case VIEW_TYPE_HELP:
                        ((TextInfoPrivacyCell) holder.itemView).setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMESCHANNELHELP, R.string.UsernamesChannelHelp));
            ...
            if (response != null) {
                ...
                for (int a = 0; a < res.chats.size(); a++) {
                    AdminedChannelCell adminedChannelCell = new AdminedChannelCell(getParentActivity(), view -> {
                        ...
                        builder.setPositiveButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_REVOKEBUTTON, R.string.RevokeButton), (dialogInterface, i) -> {
    ...
    private void updatePrivatePublic() {
        ...
        if (!isPrivate && !canCreatePublic && getUserConfig().isPremium()) {
            typeInfoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANGEPUBLICLIMITREACHED, R.string.ChangePublicLimitReached));
            ...
            loadingAdminedCell.setVisibility(View.GONE);
            if (isChannel) {
                typeInfoCell.setText(isPrivate ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELPRIVATELINKHELP, R.string.ChannelPrivateLinkHelp) : LocaleController.getString("ChannelUsernameHelp", R.string.ChannelUsernameHelp));
                headerCell.setText(isPrivate ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELINVITELINKTITLE, R.string.ChannelInviteLinkTitle) : LocaleController.getString("ChannelLinkTitle", R.string.ChannelLinkTitle));
            } else {
                typeInfoCell.setText(isPrivate ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MEGAPRIVATELINKHELP, R.string.MegaPrivateLinkHelp) : LocaleController.getString("MegaUsernameHelp", R.string.MegaUsernameHelp));
                headerCell.setText(isPrivate ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_CHANNELINVITELINKTITLE, R.string.ChannelInviteLinkTitle) : LocaleController.getString("ChannelLinkTitle", R.string.ChannelLinkTitle));
            }
            ...
            manageLinksInfoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MANAGELINKSINFOHELP, R.string.ManageLinksInfoHelp));
            if (isPrivate) {
    ...
    private boolean checkUserName(final String name) {
        ...
        if (name != null) {
            if (name.startsWith("_") || name.endsWith("_")) {
                checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKINVALID, R.string.LinkInvalid));
            ...
            for (int a = 0; a < name.length(); a++) {
                ...
                if (a == 0 && ch >= '0' && ch <= '9') {
                    if (isChannel) {
                        checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKINVALIDSTARTNUMBER, R.string.LinkInvalidStartNumber));
                    } else {
                        checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKINVALIDSTARTNUMBERMEGA, R.string.LinkInvalidStartNumberMega));
                    }
                    checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
                    return false;
                }
        ...
        if (name == null || name.length() < 4) {
            if (isChannel) {
                checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKINVALIDSHORT, R.string.LinkInvalidShort));
            } else {
                checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKINVALIDSHORTMEGA, R.string.LinkInvalidShortMega));
            }
            checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
            return false;
        }
        if (name.length() > 32) {
            checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKINVALIDLONG, R.string.LinkInvalidLong));
            checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
            return false;
        }

        checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKCHECKING, R.string.LinkChecking));
                ...
                if (lastCheckName != null && lastCheckName.equals(name)) {
                    if (error == null && response instanceof TLRPC.TL_boolTrue) {
                        ...
                        if (error != null && "USERNAME_INVALID".equals(error.text) && req.username.length() == 4) {
                            checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMEINVALIDSHORT, R.string.UsernameInvalidShort));
                            ...
                            if (req.username.length() == 4) {
                                checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMEINVALIDSHORTPURCHASE, R.string.UsernameInvalidShortPurchase));
                            } else {
                                checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERNAMEINUSEPURCHASE, R.string.UsernameInUsePurchase));
                            }
                            ...
                            checkTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_LINKINUSE, R.string.LinkInUse));
                            checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
                        }
                        lastNameAvailable = false;
                    }
        ...
        final int reqId = getConnectionsManager().sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
            if (error == null) {
                ...
                if (newRequest) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_REVOKEALERTNEWLINK, R.string.RevokeAlertNewLink));
                    builder.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_REVOKELINK, R.string.RevokeLink));
