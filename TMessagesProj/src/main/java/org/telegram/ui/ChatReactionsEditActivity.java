...
public class ChatReactionsEditActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_REACTIONS, R.string.Reactions));
        ...
        if (isChannel) {
            ...
            enableReactionsCell.setTextAndCheck(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENABLEREACTIONS, R.string.EnableReactions), !chatReactions.isEmpty(), false);
        ...
        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_AVAILABLEREACTIONS, R.string.AvailableReactions));
        ...
        allReactions.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ALLREACTIONS, R.string.AllReactions), false, true);
        someReactions = new RadioCell(context);
        someReactions.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SOMEREACTIONS, R.string.SomeReactions), false, true);
        disableReactions = new RadioCell(context);
        disableReactions.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NOREACTIONS, R.string.NoReactions), false, false);
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                switch (getItemViewType(position)) {
                    case TYPE_INFO:
                        ...
                        if (isChannel) {
                            infoCell.setText(ChatObject.isChannelAndNotMegaGroup(currentChat) ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENABLEREACTIONSCHANNELINFO, R.string.EnableReactionsChannelInfo) :
                                    LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENABLEREACTIONSGROUPINFO, R.string.EnableReactionsGroupInfo));
                        } else {
                            ...
                            if (selectedType == SELECT_TYPE_SOME) {
                                infoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENABLESOMEREACTIONSINFO, R.string.EnableSomeReactionsInfo));
                            } else if (selectedType == SELECT_TYPE_ALL) {
                                infoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ENABLEALLREACTIONSINFO, R.string.EnableAllReactionsInfo));
                            } else if (selectedType == SELECT_TYPE_NONE) {
                                infoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_DISABLEREACTIONSINFO, R.string.DisableReactionsInfo));
                            }
                        }
                        break;
                    case TYPE_HEADER:
                        HeaderCell headerCell = (HeaderCell) holder.itemView;
                        headerCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ONLYALLOWTHISREACTIONS, R.string.OnlyAllowThisReactions));
                        headerCell.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                        break;
                    case TYPE_REACTION:
