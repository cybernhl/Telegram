...
public class ContactAddActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (addContact) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_NEWCONTACT, R.string.NewContact));
        } else {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_EDITCONTACT, R.string.EditContact));
        }
        ...
        if (addContact) {
            ...
            if (needAddException) {
                ...
                checkBoxCell.setText(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceTags(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SHAREPHONENUMBERWITH, R.string.SharePhoneNumberWith)), firstName), "", true, false);
            ...
            oldPhotoCell.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETTOORIGINALPHOTO, R.string.ResetToOriginalPhoto), false);
            ...
            oldPhotoCell.setOnClickListener(v -> {
                AlertsCreator.createSimpleAlert(context,
                        LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESETTOORIGINALPHOTOTITLE, R.string.ResetToOriginalPhotoTitle),
                        LocaleController.formatString("ResetToOriginalPhotoMessage", R.string.ResetToOriginalPhotoMessage, user.first_name),
                        LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_RESET, R.string.Reset), () -> {
                            avatar = null;
...
//            getMessagesController().loadDialogPhotos(user_id, 2, 0, true, getClassGuid(), null);
    ...
    private void updateAvatarLayout() {
        ...
        if (TextUtils.isEmpty(getPhone())) {
            nameTextView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MOBILEHIDDEN, R.string.MobileHidden));
            CharSequence firstName = UserObject.getFirstName(user);
            firstName = Emoji.replaceEmoji(firstName, infoTextView.getPaint().getFontMetricsInt(), AndroidUtilities.dp(12), false);
            infoTextView.setText(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceTags(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_MOBILEHIDDENEXCEPTIONINFO, R.string.MobileHiddenExceptionInfo)), firstName));
        } else {
