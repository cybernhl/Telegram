...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, PopupSwipeBackLayout swipeBackLayout, Callback callback) {
        ...
        ActionBarMenuSubItem backItem = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_arrow_back, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BACK, R.string.Back), false, null);
        ...
        ActionBarMenuSubItem item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_0_2, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SPEEDVERYSLOW, R.string.SpeedVerySlow), false, null);
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_slow, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SPEEDSLOW, R.string.SpeedSlow), false, null);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_normal, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SPEEDNORMAL, R.string.SpeedNormal), false, null);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_fast, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SPEEDFAST, R.string.SpeedFast), false, null);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_superfast, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SPEEDVERYFAST, R.string.SpeedVeryFast), false, null);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
