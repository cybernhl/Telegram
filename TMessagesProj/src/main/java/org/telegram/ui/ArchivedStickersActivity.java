...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (currentType == MediaDataController.TYPE_IMAGE) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEDSTICKERS, R.string.ArchivedStickers));
        } else if (currentType == MediaDataController.TYPE_EMOJIPACKS) {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEDEMOJIPACKS, R.string.ArchivedEmojiPacks));
        } else {
            actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEDMASKS, R.string.ArchivedMasks));
        }
        ...
        if (currentType == MediaDataController.TYPE_IMAGE) {
            emptyView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEDSTICKERSEMPTY, R.string.ArchivedStickersEmpty));
        } else {
            emptyView.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEDMASKSEMPTY, R.string.ArchivedMasksEmpty));
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (getItemViewType(position) == 0) {
                ...
                if (position == archiveInfoRow) {
                    ...
                    cell.setText(currentType == MediaDataController.TYPE_EMOJIPACKS ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ARCHIVEDEMOJIINFO, R.string.ArchivedEmojiInfo) : LocaleController.getString("ArchivedStickersInfo", R.string.ArchivedStickersInfo));
                } else {
