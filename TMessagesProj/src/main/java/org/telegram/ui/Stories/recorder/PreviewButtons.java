...
public class PreviewButtons extends FrameLayout {
    ...
    public PreviewButtons(Context context) {
        ...
        addButton(BUTTON_PAINT, R.drawable.media_draw, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCRPAINT, R.string.AccDescrPaint));
        addButton(BUTTON_STICKER, R.drawable.msg_photo_sticker, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCRSTICKERS, R.string.AccDescrStickers));
        addButton(BUTTON_TEXT, R.drawable.msg_photo_text2, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCRPLACETEXT, R.string.AccDescrPlaceText));
        addButton(BUTTON_ADJUST, R.drawable.msg_photo_settings, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ACCDESCRPHOTOADJUST, R.string.AccDescrPhotoAdjust));

        shareButton = new ShareButtonView(context, shareText = LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SEND, R.string.Send));
        shareButton.setContentDescription(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SEND, R.string.Send));
