...
public class TrashView extends View {
    ...
    public TrashView(Context context) {
        ...
        textDrawable.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TRASHHINTDRAG, R.string.TrashHintDrag));
    ...
    public void onDragInfo(boolean dragged, boolean deleted) {
        ...
        textDrawable.setText(dragged || deleted ? LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_TRASHHINTRELEASE, R.string.TrashHintRelease) : LocaleController.getString("TrashHintDrag", R.string.TrashHintDrag));
