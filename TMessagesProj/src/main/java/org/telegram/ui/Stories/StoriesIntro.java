...
public class StoriesIntro extends FrameLayout {
    ...
    public StoriesIntro(Context context, View parentView) {
        ...
        header.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORIESINTROHEADER, R.string.StoriesIntroHeader));
        ...
        subHeader.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORIESINTROSUBHEADER, R.string.StoriesIntroSubHeader));
        ...
        items.add(new StoriesIntroItemView(context, R.raw.stories_intro_go_forward, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORIESINTROGOFORWARDHEADER, R.string.StoriesIntroGoForwardHeader), LocaleController.getString("StoriesIntroGoForwardSubHeader", R.string.StoriesIntroGoForwardSubHeader)));
        items.add(new StoriesIntroItemView(context, R.raw.stories_intro_pause, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORIESINTROPAUSEANDSEEKHEADER, R.string.StoriesIntroPauseAndSeekHeader), LocaleController.getString("StoriesIntroPauseAndSeekSubHeader", R.string.StoriesIntroPauseAndSeekSubHeader)));
        items.add(new StoriesIntroItemView(context, R.raw.stories_intro_go_back, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORIESINTROGOBACKHEADER, R.string.StoriesIntroGoBackHeader), LocaleController.getString("StoriesIntroGoBackSubHeader", R.string.StoriesIntroGoBackSubHeader)));
        items.add(new StoriesIntroItemView(context, R.raw.stories_intro_go_to_next, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORIESINTROGOTONEXTAUTHORHEADER, R.string.StoriesIntroGoToNextAuthorHeader), LocaleController.getString("StoriesIntroGoToNextAuthorSubHeader", R.string.StoriesIntroGoToNextAuthorSubHeader)));
        ...
        bottomText.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_STORIESINTRODISMISS, R.string.StoriesIntroDismiss));
