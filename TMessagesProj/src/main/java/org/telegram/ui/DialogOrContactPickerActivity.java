...
public class DialogOrContactPickerActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BLOCKUSERMULTITITLE, R.string.BlockUserMultiTitle));
    ...
    private void showBlockAlert(TLRPC.User user) {
        ...
        builder.setPositiveButton(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BLOCKCONTACT, R.string.BlockContact), (dialogInterface, i) -> {
            if (MessagesController.isSupportUser(user)) {
                AlertsCreator.showSimpleToast(DialogOrContactPickerActivity.this, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_ERROROCCURRED, R.string.ErrorOccurred));
            } else {
                MessagesController.getInstance(currentAccount).blockPeer(user.id);
                AlertsCreator.showSimpleToast(DialogOrContactPickerActivity.this, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_USERBLOCKED, R.string.UserBlocked));
            }
            finishFragment();
        });
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BLOCKUSERCHATSTITLE, R.string.BlockUserChatsTitle));
        scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_BLOCKUSERCONTACTSTITLE, R.string.BlockUserContactsTitle));
