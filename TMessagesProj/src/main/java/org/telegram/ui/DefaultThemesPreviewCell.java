...
public class DefaultThemesPreviewCell extends LinearLayout {
    ...
    public DefaultThemesPreviewCell(Context context, BaseFragment parentFragment, int type) {
        ...
        if (currentType == ThemeActivity.THEME_TYPE_BASIC) {
            ...
            browseThemesCell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SETTINGSBROWSETHEMES, R.string.SettingsBrowseThemes), R.drawable.msg_colors, false);
                ...
                public void onClick(View view) {
                    ...
                    Runnable then = () -> {
                        ...
                        if (Theme.isCurrentThemeDay()) {
                            dayNightCell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SETTINGSSWITCHTONIGHTMODE, R.string.SettingsSwitchToNightMode), darkThemeDrawable, true);
                        } else {
                            dayNightCell.setTextAndIcon(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_SETTINGSSWITCHTODAYMODE, R.string.SettingsSwitchToDayMode), darkThemeDrawable, true);
                        }
