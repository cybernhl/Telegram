...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_OPTIMIZINGTELEGRAM, R.string.OptimizingTelegram));
        ...
        description1.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_OPTIMIZINGTELEGRAMDESCRIPTION1, R.string.OptimizingTelegramDescription1));
        ...
        description2.setText(LocaleController.getString(org.telegram.messenger.utils.LangMultiExtKt.KEY_OPTIMIZINGTELEGRAMDESCRIPTION2, R.string.OptimizingTelegramDescription2));
